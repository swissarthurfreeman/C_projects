...
int unUsedVariable; //variable inutile sauf pour la question 3
...
int convert(number* res, const char* chaine) {
    ...
    *res = 0;
    ...
    for(i=length; i >= 0; i--) {
        ...
        //des entiers (table ASCII [48..57] = [0..9])
...
2. A l’aide d’un schéma, représentez l’espace d’adressage du processus sous linux
